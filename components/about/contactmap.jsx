...
const ContactMap = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex">
    <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
      ...
      <p className="leading-relaxed mb-5 text-gray-600">Share your thoughts with us!</p>
      ...
      <p className="text-xs text-gray-500 mt-3">Your contact information will not be shaorange with any party.</p>
    </div>
  </div>
</section>
    </div>
